 ...
 * 
 * ExcelMergeRow works only if the property "notMerge" in {@link com.bld.generator.report.excel.annotation.ExcelSheetLayout} is disabled.<br>
 * 
 * ExcelMergeRow is an annotation of the fields within {@link com.bld.generator.report.excel.RowSheet} classes. 
 * 
 */
@Retention(RUNTIME)
@Target(FIELD)
