 ...
 * @class com.bld.generator.report.excel.config.EnableExcelGeneratorConfiguration.java
 * 
 */
...
import com.bld.generator.report.excel.annotation.impl.ExcelAnnotationImpl;
import com.bld.generator.report.excel.config.annotation.IgnoreCheck;
 ...
 */
@Configuration
@ComponentScan({"com.bld.generator","com.bld.common.spreadsheet"})
public class EnableExcelGeneratorConfiguration {
	
	/** The Constant BLD_COMMONS_CHECK_ANNOTATION. */
	private static final String BLD_COMMONS_CHECK_ANNOTATION = "com.bld.commons.check.annotation";
	 ...
	 * <b>The property "com.bld.commons.check.annotation" must be false.</b><br> 
