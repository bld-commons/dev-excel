...
public class SalaryTest {
	...
	public void testSalary() throws Exception {
		...
		salarySheet.addRows(new SalaryRow("England","London","C",25.0));
		salarySheet.addRows(new SalaryRow("England","London","D",46.0));
		salarySheet.addRows(new SalaryRow("England","London","E",55.0));
		
		
		
		salarySheet.addRows(new SalaryRow("England","Manchester","A",8.0));
		salarySheet.addRows(new SalaryRow("England","Manchester","B",5.0));
