...
//		transformer.transform(xmlSource, res);
	...
	public void testGenerateEmployee() throws Exception {
		TestDataGenerator dataGenerator = new TestDataGenerator(TestDataGenerator.FIXED_SEED);
		...
		logger.info("Tempo generazione Excel: {}ms ({} righe totali)",
				System.currentTimeMillis() - excelStart,
				employeeSheet.getRows().size() + productSheet.getRows().size());
		...
		logger.info("Tempo generazione CSV: {}ms ({} righe)",
				System.currentTimeMillis() - csvStart, csvData.getRows().size());
